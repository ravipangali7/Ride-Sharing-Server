...
class Restaurant(models.Model):
    ...
    description = models.TextField()
    logo = models.ImageField(upload_to=upload_media, blank=True, null=True)
    cover_photo = models.ImageField(upload_to=upload_media, blank=True, null=True)
    address = models.TextField()
    latitude = models.DecimalField(max_digits=9, decimal_places=6)
    longitude = models.DecimalField(max_digits=9, decimal_places=6)
...
class MenuItem(models.Model):
    ...
    name = models.CharField(max_length=150)
    description = models.TextField()
    photo = models.ImageField(upload_to=upload_media, blank=True, null=True)
...
class Vendor(models.Model):
    ...
    store_logo = models.ImageField(upload_to=upload_media, blank=True, null=True)
    store_banner = models.ImageField(upload_to=upload_media, blank=True, null=True)
    description = models.TextField()
    address = models.TextField()
    latitude = models.DecimalField(max_digits=9, decimal_places=6)
    longitude = models.DecimalField(max_digits=9, decimal_places=6)
    ...
    registration_doc = models.FileField(upload_to=upload_media, blank=True, null=True)
    is_approved = models.BooleanField(default=False)
...
class RoomOwnerProfile(models.Model):
    ...
    full_name = models.CharField(max_length=100)
    phone = models.CharField(max_length=15)
    citizenship_photo = models.ImageField(upload_to=upload_media, blank=True, null=True)
    is_verified = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
